...
tmux set-window-option -g window-status-current-format '#[bg=brightgreen,fg=black] #I #W '
...
tmux set -g window-style 'bg=default,fg=green'
tmux set -g window-active-style 'bg=default,fg=brightgreen'
